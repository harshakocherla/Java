...
<body class="bg4">
								...
								<div class="bg1">
									...
									<div class="form-group">
										<label for="lastname">last Name:</label> <input type="text"
											class="form-control" id="signupinputcolor"
											placeholder="Enter firstname" name="lastName" required>
									</div>
									<hr>
									<p align="center">
										<b><i>Address</i></b>
									...
									<div class="form-group">
										<label for="addressline1">Address Line 1:</label> <input
											...
											placeholder="Enter addressline1" name="address.addressLine1" required>
									</div>
									<div class="form-group">
										<label for="addressline2">Address Line 2:</label> <input
											id="signupinputcolor" type="text" class="form-control"
											placeholder="Enter addressline2" name="address.addressLine2" required>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="username">User Name:</label> <input type="text"
											class="form-control" id="signupinputcolor"
											placeholder="Enter username" name="login.username" required>
									</div>
									<div class="form-group">
	...
	<div class="tab-content">
		...
		<div id="myTickets" class="container tab-pane fade" align="center"
			...
			<p>
				<small>Please signin to view or manage tickets</small>
			</p>
